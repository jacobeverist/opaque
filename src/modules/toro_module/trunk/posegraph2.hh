...
struct TreePoseGraph2: public TreePoseGraph< Operations2D<double> >{
  ...
  bool loadDirect(int nPoints, int nEdges, int *vertIDs, double *vertPoses, int *vertPairs, double *offsets, double *covars);
  bool readDirect(int nPoints, int nEdges, int *vertIDs, double *vertPoses, int *vertPairs, double *offsets, double *covars);

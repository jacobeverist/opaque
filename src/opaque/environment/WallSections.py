...
class WallSections:
	...
	def createWall(self, points):
		...
		s = self._mgr.createStaticGeometry("corridor_%04u" % self.count)
		...
		mo1_int = ogre.ManualObject("WallObject_Interior_" + str(self.count))
		mo1_int.begin("WallMaterial_Int_", ogre.RenderOperation.OT_TRIANGLE_LIST)

		mo1_ext = ogre.ManualObject("WallObject_Exterior_" + str(self.count))
		mo1_ext.begin("WallMaterial_Ext_", ogre.RenderOperation.OT_TRIANGLE_LIST)

		mo1_top = ogre.ManualObject("WallObject_Top_" + str(self.count))
		mo1_top.begin("WallMaterial_Top_", ogre.RenderOperation.OT_TRIANGLE_LIST)
		...
		# convert to mesh
		mo1_int.convertToMesh("WallMesh_Interior_" + str(self.count))

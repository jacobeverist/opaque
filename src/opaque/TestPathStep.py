...
class TestPathStep(SnakeControl):
	...
	def frameStarted(self):
		...
		# Anchor to the walls
			...
			wayPath = [[0.0,0.0],[8.0,0.0]]
			
			self.pathStep = PathStep(self.robotParam, self.contacts, self.mapGraph, False)
			self.pathStep.probeState = self.probe.getProbeState()
			self.pathStep.setPath(wayPath)
		...
		# Anchor to the walls
			...
			joints1 = self.pathStep.getJoints()
